...
<body>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>亿中景</a> <t:mutiLang langKey="common.browser.recommend"/>:<a href="#" title=<t:mutiLang langKey="common.platform"/>>亿中景</a></span></div>
    </div>
    <!-- Link JScript-->
