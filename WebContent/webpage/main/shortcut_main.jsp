...
<tr>
    ...
    <!--
        ...
        <div style="position: absolute; top: 75px; left: 33px;"> <span style="letter-spacing: -1px;"> </span></div>
    </td>
            ...
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                        ...
                        <span style="color: #FFFFFF">${LoginUser_schoolName }</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.guofengkj.com/" title="北京亿中景科技发展有限公司">北京亿中景科技发展有限公司</a>
            <t:mutiLang langKey="common.browser"/>:
            <a href="#" title="北京亿中景科技发展有限公司">北京亿中景科技发展有限公司</a>
        </span>
    </div>
</div>
