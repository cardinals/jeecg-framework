...
<!-- 顶部-->
<div region="north" border="false" title=" 亿中景" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
        ...
        <table>
            <tr>
                <td valign="top" height="50">
                    ...
                    <span style="color: #666633">${LoginUser_schoolName }</span>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.guofengkj.com/" title="亿中景科技发展有限公司">亿中景科技发展有限公司</a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title="亿中景科技发展有限公司">亿中景科技发展有限公司</a>
        </span>
    </div>
</div>
