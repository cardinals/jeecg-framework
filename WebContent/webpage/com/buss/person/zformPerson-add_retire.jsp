	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zformPersonController.do?doAdd">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value"><input id="birthday" name="birthday" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><input id="startWorkDate" name="startWorkDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">参加工作时间</label></td>
			...
			<tr>
				...
				<td class="value"><input id="graduateDate" name="graduateDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><input id="enterDate" name="enterDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">进入行业时间</label></td>
				<td align="right"><label class="Validform_label">初级职称取得时间:</label></td>
				<td class="value"><input id="juniorTitleDate" name="juniorTitleDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">初级职称取得时间</label></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label">中级职称取得时间:</label></td>
				<td class="value"><input id="secondaryTitleDate" name="secondaryTitleDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span>
					<label class="Validform_label" style="display: none;">中级职称取得时间</label></td>
				<td align="right"><label class="Validform_label">高级职称取得时间:</label></td>
				<td class="value"><input id="seniorTitleDate" name="seniorTitleDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"> <span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">高级职称取得时间</label></td>
			</tr>
			<tr>
	...
	<table style="display:none">		
		<tbody id="add_zformPersonRetire_table_template">
			<tr>
				...
				<td align="left"><input name="zformPersonRetireList[#index#].retireCardNo" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonRetireList[#index#].workAge" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonRetireList[#index#].retireDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">退休日期</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].pensionStartDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">开始领取退休金日期</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].auditDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">退休审批日期</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].jobSalary" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">岗位工资</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].rankSalary" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">薪级工资</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].extraSalary" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">百分之十部分</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].teachExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">特教津贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].teachAgeExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">教龄津贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].liveExtra2007" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">07年生活补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].dutyExtra2010" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">10年按职务增加补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].ageExtra2010" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">10年按年龄增加补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].instituteExtra2011" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">11年事业增加补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].instituteExtra2013" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">13年事业增加补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].instituteExtra2014" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">14年事业增加补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].growthExtra2011" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">11年增长机制补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].workAgeExtra2011" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">11年工作年限补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].pensionUpgrade2011" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">11年提高退休费补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].houseRentExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公有住房提租补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].bookExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">书报洗理费</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].surplusExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">包干结余奖</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].workModelExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">劳模荣誉津贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].seniorTeacherExtra" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">特级教师津贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].instituteBasic" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">事业基本退休费</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].dutySalary1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员职务工资</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].rankSalary1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员级别工资</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].policeRankSalary1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员警衔津贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].dutyExtra1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员职务补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].ageExtra1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员年龄补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].workAgeExtra1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员工作年限补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].pensionUpgrade1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员提高退休费补贴</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].serventBasic1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">公务员基本退休费</label></td>
				<td align="left"><input name="zformPersonRetireList[#index#].comments" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">备注</label></td>
			</tr>
		</tbody>
		<tbody id="add_zformPersonStatus_table_template">
			<tr>
				...
				<td align="left"><input name="zformPersonStatusList[#index#].stateChangeReason" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">变更原因</label></td>
				<td align="left"><input name="zformPersonStatusList[#index#].statusChangeDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">变更日期</label></td>
			</tr>
		</tbody>
	</table>
</body>
