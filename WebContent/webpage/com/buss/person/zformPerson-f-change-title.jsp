...
<body style="overflow-x: hidden;">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zformPersonController.do?doChangeTitle">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>				
				...
				<td align="right"><label class="Validform_label">职务变动原因 </label></td>
				<td class="value"><input id="changeReason" name="changeReason" type="text" style="width: 150px" class="inputxt"> 
					<span class="Validform_checktip"></span> 
					<label class="Validform_label"style="display: none;">职务变动原因</label>
				</td>
