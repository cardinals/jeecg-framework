...
<body style="overflow-x: hidden;">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zformPersonController.do?doUpdate&updateStatus=13">
	...
	<table style="display:none">
		<tbody id="add_zformPersonActive_table_template">
			<tr>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].currentTitleExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">现职称扩充</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].currentTitleDate" maxlength="200" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">现职称评审日期</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].executiveTitle" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonActiveList[#index#].currentJobExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">所聘岗位扩充</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].jobSalary" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonActiveList[#index#].rankSalary" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">薪级工资</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].extraSalary" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">百分之十工资</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].totalSeniority" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">累计工龄</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].teachingSeniority" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">教龄</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].teachingCourse1" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">任教课程1</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].teachingClassNo1" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">任教节数1</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].teachingCourse2" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">任教课程2</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].teachingClassNo2" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">任教节数2</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].contractTerm" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">聘用合同聘期</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].contractEndDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">聘用合同截止日期</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].probationEndDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">转正定级日期</label></td>
				...
				<td align="left"><input name="zformPersonActiveList[#index#].teacherCertDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">教师资格证颁发日期</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].regEndDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonActiveList[#index#].department" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">所在部门</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].weeklyHours" maxlength="10" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">周课时</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].serviceEndDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">服务期截止日期</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].serviceRemainDate" maxlength="32" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">服务期剩余时间</label></td>
				<td align="left"><input name="zformPersonActiveList[#index#].comments" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
		...
		<tbody id="add_zformPersonPunish_table_template">
			<tr>
				<td align="center"><div style="width: 25px;" name="xh"></div></td>
				<td align="center"><input style="width:20px;" type="checkbox" name="ck" /></td>
				<td align="left"><input name="zformPersonPunishList[#index#].punishment" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">所受处分情况</label></td>
				<td align="left"><input name="zformPersonPunishList[#index#].punishmentEndDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;"> <label
					class="Validform_label" style="display: none;">所受处分到期日期</label></td>
				<td align="left"><input name="zformPersonPunishList[#index#].comments" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">备注</label></td>
			</tr>
		</tbody>
		<tbody id="add_zformPersonTitle_table_template">
			<tr>
				...
				<td align="left"><input name="zformPersonTitleList[#index#].prevTitleExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonTitleList[#index#].prevJobExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonTitleList[#index#].newTitleExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonTitleList[#index#].newJobExtra" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
				...
				<td align="left"><input name="zformPersonTitleList[#index#].changeReason" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">职务变动原因</label></td>
				<td align="left"><input name="zformPersonTitleList[#index#].effectiveDate" maxlength="50" type="text" class="Wdate" onClick="WdatePicker()" style="width:120px;" datatype="*"> <label
					class="Validform_label" style="display: none;">职务变动生效日期</label></td>
				<td align="left"><input name="zformPersonTitleList[#index#].comments" maxlength="200" type="text" class="inputxt" style="width:120px;"> <label class="Validform_label"
					style="display: none;">备注</label></td>
			</tr>
		</tbody>
