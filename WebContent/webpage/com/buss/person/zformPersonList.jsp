...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zformPersonList" checkbox="true" fitColumns="false" title="人员基本信息数据库" actionUrl="zformPersonController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="人员姓名"  field="name"    queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="民族"  field="nationality"    queryMode="single" dictionary="national" width="120"></t:dgCol>
   <t:dgCol title="政治面貌"  field="socialStatus"    queryMode="single" dictionary="social_s" width="120"></t:dgCol>
   <t:dgCol title="参加工作时间"  field="startWorkDate" formatter="yyyy-MM-dd"   queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="学历"  field="eduBackground"    queryMode="single" dictionary="edu_back" width="120"></t:dgCol>
   <t:dgCol title="学历补充"  field="eduExtra"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="学位"  field="degree"    queryMode="single" dictionary="degree" width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="zformPersonController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="zformPersonController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="zformPersonController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="zformPersonController.do?goUpdate" funname="detail"></t:dgToolBar>
