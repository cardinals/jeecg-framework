...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zformRankSalaryController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="year" name="year" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${zformRankSalaryPage.year}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="salary" name="salary" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${zformRankSalaryPage.salary}'>
							<span class="Validform_checktip"></span>
