...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zformJobSalaryController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="jobExtra" name="jobExtra" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${zformJobSalaryPage.jobExtra}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="salary" name="salary" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${zformJobSalaryPage.salary}'>
							<span class="Validform_checktip"></span>
